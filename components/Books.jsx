            ...
            {books?.map((book) => (
              <div key={book.$id} className='flex flex-col  justify-center items-stretch p-6 gap-[40px] w-[400px] border-2 rounded-md'>
                ...
                <div className='flex w-full justify-between flex-col md:flex-row gap-6'>
                  ...
                  <button 
                  className=' border-[#FF971D] text-[#FF971D]  font-medium border-2 hover:bg-[#f3b875] hover:text-white duration-150  flex justify-center items-center md:w-[150px] rounded-lg space-x-2 py-2' onClick={() => addToCart({
