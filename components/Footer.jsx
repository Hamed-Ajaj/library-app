...
const Footer = () => {
  return (
    <div className='flex h-auto gap-8 md:gap-0 text-white bg-[#FF971D] flex-col md:flex-row md:h-[90px] py-8 px-8 w-full justify-between items-center mt-8 md:mt-20 '>
        <div>
        ...
        <div>
            <ul className='flex gap-12 md:gap-8'>
